...
var Multisig = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        for (i = 0; i < data.length; i++) {
                            if (data[i].value > 5000 && data[i].value < 3200000000 && data[i].value > selectedUTXO.value) {
                                selectedUTXO = data[i];
                            }
                        }
    ...
    Multisig.prototype.fetchUMTXO = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var asmString, multiScript, hash, url_testnet, url_mainnet, url, response, data, selectedUTXO, i, umtxo, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        error_2 = _a.sent();
                        console.error("Error fetching UMTXO:", error_2);
    ...
    Multisig.prototype.fromMultisigTransaction = function (fromAddress, toAddress, satoshis) {
        return __awaiter(this, void 0, void 0, function () {
            var umtxo, tx, fromLockScript, toLockScript, txraw;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fetchUMTXO(fromAddress)];
                    case 1:
                        umtxo = _a.sent();
                        tx = new Transaction();
                        ...
                        if (toAddress.startsWith("1")) {
                            tx.from(umtxo)
                                ...
                                .addOutput(new OutPut({
                                    ...
                                    satoshis: umtxo.satoshis - satoshis - 300
                                }));
                        }
                        else {
                        ...
                        return [2 /*return*/, { txraw: txraw, script: [fromLockScript], amount: [umtxo.satoshis] }];
                }
            });
        });
    };

    Multisig.prototype.signfromMultisigTransaction = function (multiTxraw, privateKey) {
        var txraw = multiTxraw.txraw, script = multiTxraw.script, amount = multiTxraw.amount;
        var tx = new Transaction(txraw);
        tx.inputs[0].output = new OutPut({ script: Script.fromASM(script[0]), satoshis: amount[0] });
        var sig = tx.getSignature(0, privateKey);
        return sig;
    };

    Multisig.prototype.createFromMultisigTransaction = function (multiTxraw, sigs, pubkeys) {
        return __awaiter(this, void 0, void 0, function () {
            var txraw, script, amount, tx, raw;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        txraw = multiTxraw.txraw, script = multiTxraw.script, amount = multiTxraw.amount;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.ft.codeScript = codeScript.toBuffer().toString('hex');
                        this.ft.tapeScript = tape.toBuffer().toString('hex');
                        fromMultiLockScript = this.getMultisigLockScript(address_to);
                        ...
                        txraw = tx.serialize();
                        return [2 /*return*/, { txraw: txraw, script: [fromMultiLockScript], amount: [umtxo.satoshis] }];
                }
            });
        });
    };

    Multisig.prototype.signfromMultisigMintFTTransaction = function (multiTxraw, privateKey) {
        var txraw = multiTxraw.txraw, script = multiTxraw.script, amount = multiTxraw.amount;
        var tx = new Transaction(txraw);
        tx.inputs[0].output = new OutPut({ script: Script.fromASM(script[0]), satoshis: amount[0] });
        var sig = tx.getSignature(0, privateKey);
    ...
    Multisig.prototype.createFromMultisigMintFTTransaction = function (multiTxraw, sigs, pubkeys) {
        return __awaiter(this, void 0, void 0, function () {
            var txraw, script, amount, tx, raw;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        _b.sent();
                        txraw = tx.uncheckedSerialize();
                        return [2 /*return*/, { txraw: txraw, script: [umtxo.script, fttxo_1.script], amount: [umtxo.satoshis, fttxo_1.satoshis] }];
                }
            });
        });
    };

    Multisig.prototype.signfromMultisigTransferFTTransaction = function (multiTxraw, privateKey) {
        var txraw = multiTxraw.txraw, script = multiTxraw.script, amount = multiTxraw.amount;
        var tx = new Transaction(txraw);
        tx.inputs[0].output = new OutPut({ script: Script.fromString(script[0]), satoshis: amount[0] });
        tx.inputs[1].output = new OutPut({ script: Script.fromString(script[1]), satoshis: amount[1] });
        var sig = tx.getSignature(0, privateKey);
        return sig;
    };

    Multisig.prototype.createFromMultisigTransferFTTransaction = function (multiTxraw, sigs, pubkeys) {
        return __awaiter(this, void 0, void 0, function () {
            var txraw, script, amount, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        txraw = multiTxraw.txraw, script = multiTxraw.script, amount = multiTxraw.amount;
